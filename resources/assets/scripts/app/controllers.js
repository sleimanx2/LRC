...
angular.module("app.form.map", [])
    ...
    .directive('googleDestination', function () {
        return {
            ...
            replace: true,
            scope: true,
            template: '<input id="google_places_destination" placeholder="Enter a destination" name="google_places_destination" type="text" class="form-control" data-ng-model="form.destination" data-ng-value="form.destination" />',
            link: function ($scope, elm, attrs) {
